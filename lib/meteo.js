var Meteo = (function () {
    ...
    my.prototype.toggleModel = function() {
    ...
    my.prototype.getCities = function(capital) {
        var cities, ret, i;
    ...
    my.prototype.setCity = function(city) {
        var pos;
    ...
    my.prototype.showImage=function(force) {
        var time, xmlhttp, that=this;
        time = (new Date()).getTime();

        if(!force && (time-this.lastUpdate)<UPDATE_INTERVAL) {
            console.log('To soon!');
            return;
        }
        ...
        xmlhttp.open('GET', URLS[this.model].date, true);
    ...
    my.prototype._getCityPosition = function(city) {
        return CITIES[city][this.model];
    };

    my.prototype._loadImage = function(date, force) {
        if(!force && date===this.lastDate) {
            console.log('Date not changed!');
            return;
        }
        this.date=date;
        this.frame.src=URLS[this.model].mgram.format(this.date, this.row, this.col, this.lang, this.city);
    };
